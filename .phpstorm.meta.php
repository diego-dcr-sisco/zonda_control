...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/diego-dcr/Documentos/siscoplagas/ERP/ZONDA/control_maestro/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/diego-dcr/Documentos/siscoplagas/ERP/ZONDA/control_maestro/public/storage',
...
'profile.destroy','subscriptions.index','subscriptions.create','subscriptions.edit','subscriptions.update',
'subscriptions.store','subscriptions.edit.view','subscriptions.destroy','subscriptions.adminsCreate','subscriptions.branches',
'subscriptions.admins','subscriptions.admin.edit','subscriptions.admin.update','subscriptions.adminStore','subscriptions.branch.edit',
'subscriptions.branch.update','subscriptions.users.index','subscriptions.users.edit','subscriptions.users.update','subscriptions.users.update.client',
'subscriptions.branch.user.create','subscriptions.branch.user.store','subscriptions.permissions','subscriptions.permission.update','plans.index',
'plans.create','plans.store','plans.edit','plans.destroy','plans.update',
...
'layouts.app','layouts.guest','layouts.header','layouts.navbar','layouts.navigation',
'links.cdn','messages.alert','permissions.index','plans.create','plans.edit',
'plans.index','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
'subscriptions_management.admins.create','subscriptions_management.admins.edit','subscriptions_management.admins.index','subscriptions_management.branch.branches','subscriptions_management.branch.edit',
'subscriptions_management.create','subscriptions_management.edit','subscriptions_management.index','subscriptions_management.tables.subscriptions','users.create',
